...
const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    description:
      "Built custom web applications for various clients including e-commerce platforms, business management systems, and portfolio websites.",
    technologies: [
      "React",
      "Vue.js",
      "Node.js",
    ...
    achievements: [
      ...
      "Generated $25,000+ in revenue through freelance work",
      "Built scalable e-commerce solutions for 3 different industries",
  ...
  },
  {
    ...
    description:
      "Gained hands-on experience in software development lifecycle, working on real-world projects under senior developers' guidance.",
    technologies: ["JavaScript", "React", "Express.js", "MySQL", "Git", "Jest"],
    achievements: [
      "Contributed to 3 major features in the company's flagship product",
  ...
  },
  {
    ...
    period: "2019 - 2020",
    description:
      "Developed various academic projects including web applications, mobile apps, and research-based software solutions.",
    technologies: [
      "Python",
      "Java",
      "HTML/CSS",
    ...
    achievements: [
      ...
      "Won 2nd place in university coding competition",
      "Published research paper on web accessibility",
      "Led team of 4 students in capstone project",
    ],
